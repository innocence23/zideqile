                    ...
                    <div class="modal-body">
                        <form name="myForm" id="form1" novalidate>
                            <div class="form-group" ng-class="{ 'has-error' : !myForm.name.$pristine && myForm.name.$invalid }">
                                ...
                                <input type="text" class="form-control" name="name"  id="front-user-name" required ng-model="front_user.name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email"  id="front-user-email" ng-model="front_user.email" />
                            </div>
                        </form>
                    </div>
        ...
        angular.module('myModule', ['bsTable'])
            .controller('myController', function ($scope, $http) {
                ...
                $scope.btnquery = function () {
                    $("#table").bootstrapTable('refresh', {url: "{{route('front-user.lists')}}"});
                ...
                $scope.save = function (modalstate, id) {
                    var url = "{{route('front-user.store')}}";
                    var dataparam = $.param($scope.front_user);
                    if (modalstate === 'edit') {
                        url += '/' + id;
