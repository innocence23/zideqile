                    ...
                    <div class="modal-body">
                        <form name="myForm" id="form1" novalidate>
                            <div class="form-group" ng-class="{ 'has-error' : !myForm.name.$pristine && myForm.name.$invalid }">
                                <label for="permission-name" class="control-label">名称:</label>
                                <input type="text" class="form-control" name="name"  id="permission-name" required ng-model="permission.name">
                                <p ng-show="!myForm.name.$pristine && myForm.name.$invalid" class="help-block">不能为空</p>
                            </div>
                            <div class="form-group">
                                <label for="permission-display_name" class="control-label">权限描述:</label>
                                <input type="text" class="form-control" name="display_name"  id="permission-display_name" ng-model="permission.display_name">
                            </div>
                            <div class="form-group">
                                <label for="permission-description" class="control-label">其他描述:</label>
                                <input type="text" class="form-control" name="description"  id="permission-description" ng-model="permission.description">
                            </div>
                        </form>
                    </div>
        ...
        angular.module('myModule', ['bsTable'])
            .controller('myController', function ($scope, $http) {
                ...
                $scope.save = function (modalstate, id) {
                    ...
                    var dataparam = $.param($scope.permission);
                    if (modalstate === 'edit') {
                        url += '/' + id;
