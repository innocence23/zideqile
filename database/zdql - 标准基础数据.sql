...
-- 汉语字典数据
-- ----------------------------
INSERT INTO `dicts` VALUES ('1', '天', '天', '天', 'tian', '1', '11', 'zitu/HWenFlS32LXFB0Ni4y9DjHxC7XCiupUOaRyKq3Qh.png', '2017-10/9PbNwLjy4YvkQ34InNjDho2nrE1wkza5bL3oDP51.png', '无', '顚也。至高無上，从一大。他前切', '<p><strong>顚也。</strong>此以同部曡韵爲訓也。凡門聞也，戸護也，尾微也，髮拔也皆此例。凡言元始也，天顚也，丕大也，吏治人者也皆於六書爲轉注而微有差別。元始可互言之。天顚不可倒言之。葢求義則轉移皆是。舉物則定名難假。然其爲訓詁則一也。顚者，人之頂也。以爲凡高之偁。始者，女之初也。以爲凡起之偁。然則天亦可爲凡顚之偁。臣於君，子於父，妻於夫，民於食皆曰天是也。<strong>至高無上。从一大。</strong>至高無上。是其大無有二也。故从一大。於六書爲<strong>㑹</strong>意。凡<strong>㑹</strong>意合二字以成語。如一大，人言，止戈皆是。他前切。十二部。</p>', '<p>天地人</p>\r\n\r\n<p>天下</p>\r\n\r\n<p>天气</p>', '1', '1', '1', '2017-10-11 17:11:03', '2017-10-17 19:22:48');
